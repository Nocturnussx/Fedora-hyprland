...
![](https://img.shields.io/github/last-commit/Nocturnussx/fedora-hyprland?&style=for-the-badge&color=8ad7eb&logo=git&logoColor=D9E0EE&labelColor=1E202B)
![](https://img.shields.io/github/stars/Nocturnussx/fedora-hyprland?style=for-the-badge&logo=andela&color=86dbd7&logoColor=D9E0EE&labelColor=1E202B)
![](https://img.shields.io/github/repo-size/Nocturnussx/fedora-hyprland?color=86dbce&label=SIZE&logo=protondrive&style=for-the-badge&logoColor=D9E0EE&labelColor=26230e)
...
```bash
bash <(curl -s https://raw.githubusercontent.com/Nocturnussx/fedora-hyprland/f43/setup.sh)
```
or if you are using fish shell (non-posix-compliant shell) then:
   
```bash
bash -c "$(curl -s https://raw.githubusercontent.com/Nocturnussx/fedora-hyprland/f43/setup.sh)"
```

...
```bash
bash <(curl -s https://raw.githubusercontent.com/Nocturnussx/fedora-hyprland/f42/setup.sh)
```
or if you are using fish shell (non-posix-compliant shell) then:
   
```bash
bash -c "$(curl -s https://raw.githubusercontent.com/Nocturnussx/fedora-hyprland/f42/setup.sh)"
```
